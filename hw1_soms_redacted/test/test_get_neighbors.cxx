...
int main(int argc, char** argv) {
    ...
    vector<CellIndex> expected_indexes;
    expected_indexes.push_back(CellIndex(0, 0));
    expected_indexes.push_back(CellIndex(0, 1));
    expected_indexes.push_back(CellIndex(1, 0));
    expected_indexes.push_back(CellIndex(1, 1));
    expected_indexes.push_back(CellIndex(2, 0));
    expected_indexes.push_back(CellIndex(2, 1));

    compare_indexes(neighbor_indexes, expected_indexes);

    cout << endl << endl << "testing neighbor radius 2" << endl;
    ...
    expected_indexes.clear();
    expected_indexes.push_back(CellIndex(0, 0));
    expected_indexes.push_back(CellIndex(0, 1));
    expected_indexes.push_back(CellIndex(0, 2));
    expected_indexes.push_back(CellIndex(1, 0));
    expected_indexes.push_back(CellIndex(1, 1));
    expected_indexes.push_back(CellIndex(1, 2));
    expected_indexes.push_back(CellIndex(2, 0));
    expected_indexes.push_back(CellIndex(2, 1));
    expected_indexes.push_back(CellIndex(2, 2));
    expected_indexes.push_back(CellIndex(3, 0));
    expected_indexes.push_back(CellIndex(3, 1));
    expected_indexes.push_back(CellIndex(3, 2));
    ...
    for (int32_t y = 0; y < 5; y++) {
        for (int32_t x = 0; x < 5; x++) {
            expected_indexes.push_back(CellIndex(y, x));
        }
    }
