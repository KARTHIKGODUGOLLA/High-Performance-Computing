...
int main(int argc, char** argv) {
    ...
    CellIndex i1(1, 3);
    CellIndex i2(0, 0);
    double theta = som->neighborhood_function(i1, i2);
    cout << "theta(" << i1 << ", " << i2 << "): " << setprecision(15) << theta << endl;
    compare_doubles("theta 1", theta, 0.0625);

    i1 = CellIndex(1, 3);
    i2 = CellIndex(4, 3);
    theta = som->neighborhood_function(i1, i2);
    cout << "theta(" << i1 << ", " << i2 << "): " << setprecision(15) << theta << endl;
    compare_doubles("theta 1", theta, 0.125);
    ...
    theta = som->neighborhood_function(i1, i2);
    cout << "theta(" << i1 << ", " << i2 << "): " << setprecision(15) << theta << endl;
    compare_doubles("theta 1", theta, 1.0);
    ...
    theta = som->neighborhood_function(i1, i2);
    cout << "theta(" << i1 << ", " << i2 << "): " << setprecision(15) << theta << endl;
    compare_doubles("theta 1", theta, 0.03125);
