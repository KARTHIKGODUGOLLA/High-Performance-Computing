...
class SelfOrganizingMap {
    public:
         ...
         */
        SelfOrganizingMap(vector<string> _labels, uint32_t _sample_size, uint32_t _height, uint32_t _width);
        SelfOrganizingMap(vector<string> _labels, uint32_t _sample_size, uint32_t _height, uint32_t _width, int32_t seed);
