...
class Griewank : public ObjectiveFunction {
    public:
        ...
        /**
         * Constructs a Griewank objective function object.
         *
         ...
         */
        Griewank(int n_parameters, double min_parameter_value, double max_parameter_value);

        /**
         * Computes the Griewank objective function.
         *
